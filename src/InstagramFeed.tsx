    ...
    posts.map((post, index) => {
      ...
      let mediaEl = (
        <img
          ...
          style={{
            ...
            objectFit: "cover",
            transform:
              hovered?.id === index && hovered.state
                ? "scale(1.1)"
                : "scale(1)",
      ...
      return (
        <div
          ...
          key={index}
          onMouseEnter={() => setHovered({ id: index, state: true })}
          onMouseLeave={() => setHovered({ id: index, state: false })}
        >
          <a href={post.permalink} target="_blank" rel="noopener noreferrer">
            ...
            <div
              style={{
                ...
                transition: "all 0.3s ease",
                opacity: hovered?.id === index && hovered.state ? "1" : "0",
              }}
            >
              <svg
                fill="#ffffff"
